...
export input=./data/mila-face.v0.2
export model_name="milaface.v0.3.7"
# export resume_from="output/${model_name}/${model_name}-state"
export resume_from="output/milaface.v0.3/milaface.v0.3-state"
export steps=1000
