...
mkdir -p ${out_dir}
resolution="420,600 --random_crop --enable_bucket"
...
# resume_from="output/missionary_pov.v1.6-2023-04-09-21-03-01/missionary_pov.v1.6-state/"
...
style="--n illustration, 3d, sepia, painting, cartoons, sketch, (worst quality:2), (low quality:2), (normal quality:2), lowres, bad anatomy, bad hands, normal quality, ((monochrome)), ((grayscale:1.2)), futanari, full-package_futanari, penis_from_girl, newhalf, collapsed eyeshadow, multiple eyebrows, vaginas in breasts,holes on breasts, fleckles, stretched nipples, nipples on buttocks, analog, analogphoto, signatre, logo,2 faces"
trigger=""

sample_res="--h 384 --w 576"
sample_res_h="--h 576 --w 384"

echo "${trigger} blowjob ${sample_res}
${trigger}, missionary mlegs  ${style} ${sample_res}
${trigger}, missionary vlegs ${style} ${sample_res}
${trigger}, missionary olegs ${style} ${sample_res}
${trigger}, missionary legs up ${style} ${sample_res_h}
${trigger}, cowgirl ${style} ${sample_res_h}
${trigger}, doggy style ${style} ${sample_res_h}
" > ${sample_prompts}
