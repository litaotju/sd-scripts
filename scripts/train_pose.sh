...
trigger="missionary pov"

sample_res="--h 384 --w 576"
sample_res_h="--h 576 --w 384"

echo "${trigger} ${sample_res}
${trigger}, no face ${style} ${sample_res}
${trigger}, arms crossed ${style} ${sample_res}
${trigger}, spreading legs ${style} ${sample_res}
${trigger}, hands on tits ${style} ${sample_res_h}
${trigger}, touching pussy ${style} ${sample_res_h}
" > ${sample_prompts}
